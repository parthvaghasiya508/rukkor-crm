...
import { addReason } from "../redux/actions/reason";
import { connect } from "react-redux";

export class AddReason extends Component {
  constructor(props) {
    super(props);
  ...
  onSubmit = (e) => {
    ...
    if (this.validateForm()) {
      ...
      this.props.addReason(formData, config, this.props);
    }
  };
