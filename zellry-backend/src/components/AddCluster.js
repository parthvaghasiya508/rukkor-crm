...
import { addCluster } from "../redux/actions/cluster";
import { connect } from "react-redux";

export class AddCluster extends Component {
  constructor(props) {
    super(props);
  ...
  onSubmit = (e) => {
    ...
    if (this.validateForm()) {
      ...
      this.props.addCluster(formData, config, this.props);
    }
  };
...
export default connect(mapStateToProps, mapDispatchToProps)(AddCluster);
