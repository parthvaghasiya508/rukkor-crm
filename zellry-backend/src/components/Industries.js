...
export class Industries extends Component {
  ...
  paginate = (pageNumber) => (e) => {
    ...
    this.props.getIndustries(pageNumber,search_keyword);
  };
  ...
  handleEdit = (id) => (e) => {
    this.props.history.push(`/edit-industry/${id}`);
  };
  ...
  confirmDelete = (e) => {
    this.props.deleteIndustry(this.state.selectedId,this.props);
  ...
  searchData = (e) => {
    ...
    this.props.getIndustries(page,search_keyword);
  };
          ...
          <div className="container-fluid">
            <div className="card shadow mb-4">
              ...
              <div className="card-body">
                      ...
                      this.props.industries.length > 0 ? (
                        this.props.industries.map((industry, index) => (
                          <tr key={industry._id}>
                            ...
                            <td>{industry.status_text}</td>

                            <td className="text-center">
                              <i
                                onClick={this.handleEdit(industry._id)}
                            ...
                            <td className="text-center">
                              <i
                                onClick={this.handleDelete(industry._id)}
                ...
                {this.props.industries.length > 0 && this.props.pagination ? (
                  <>
...
const mapStateToProps = state => ({ industries: state.industry.list, pagination: state.industry.pagination });
const mapDispatchToProps = {
  getIndustries,deleteIndustry
};
