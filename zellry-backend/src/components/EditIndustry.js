...
import { getIndustry, updateIndustry } from "../redux/actions/industry";
import { connect } from "react-redux";

export class EditIndustry extends Component {
  constructor(props) {
    super(props);
  ...
  componentDidMount = async () => {
    try {
      ...
      await this.props.getIndustry(param);

      // Set Redux Data With State
      const { title, status } = this.props.industry;
  ...
  onSubmit = (e) => {
    ...
    if (this.validateForm()) {
      ...
      this.props.updateIndustry(formData, config, this.props);
    }
  };
  ...
  render() {
    ...
    return (
      <>
        ...
        <Layout title="Edit Industry">
          <div className="container-fluid">
            {/* Page Heading */}
            {/* <h1 className="h3 mb-1 text-gray-800"> Edit Industry </h1>
            <p className="mb-4">Edit Industry Personal Detail</p> */}
            {/* Content Row */}
            <div className="row">
...
const mapStateToProps = (state) => ({
  industry: state.industry.single,
