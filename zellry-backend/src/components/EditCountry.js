...
import { getCountry, updateCountry } from "../redux/actions/country";
import { connect } from "react-redux";

export class EditCountry extends Component {
  constructor(props) {
    super(props);
  ...
  componentDidMount = async () => {
    try {
      ...
      await this.props.getCountry(param);

      // Set Redux Data With State
      const { title, status } = this.props.country;
  ...
  onSubmit = (e) => {
    ...
    if (this.validateForm()) {
      ...
      this.props.updateCountry(formData, config, this.props);
    }
  };
  ...
  render() {
    ...
    return (
      <>
        ...
        <Layout title="Edit Country">
          <div className="container-fluid">
            {/* Page Heading */}
            {/* <h1 className="h3 mb-1 text-gray-800"> Edit Country </h1>
            <p className="mb-4">Edit Country Personal Detail</p> */}
            {/* Content Row */}
            <div className="row">
