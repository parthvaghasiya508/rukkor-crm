...
import { getCluster, updateCluster } from "../redux/actions/cluster";
...
export class EditCluster extends Component {
  ...
  componentDidMount = async () => {
    try {
      ...
      await this.props.getCluster(param);

      // Set Redux Data With State
      const { title, status } = this.props.cluster;
  ...
  onSubmit = (e) => {
    ...
    if (this.validateForm()) {
      ...
      this.props.updateCluster(formData, config, this.props);
    }
  };
  ...
  render() {
    ...
    return (
      <>
        ...
        <Layout title="Edit Cluster">
          <div className="container-fluid">
            {/* Page Heading */}
            {/* <h1 className="h3 mb-1 text-gray-800"> Edit Cluster </h1>
            <p className="mb-4">Edit Cluster Personal Detail</p> */}
            {/* Content Row */}
            <div className="row">
